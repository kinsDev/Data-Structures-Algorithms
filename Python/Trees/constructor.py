...
A Node class, which serves as the building block for the binary search tree. 
...
The BinarySearchTree class should have an __init__ method that initializes an empty binary search tree. 
